...
from yamada import SpatialGraphDiagram, Edge, Crossing, available_r1_moves, apply_r1_move
...
def test_r1_unknot_inf_cw_2e_0v_1c_1(unknot_inf_cw_2e_0v_1c_1, poly_unknot):
    ...
    sgd_post_r1 = apply_r1_move(sgd, 'c1')
