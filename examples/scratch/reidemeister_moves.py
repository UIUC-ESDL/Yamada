...
sgd_has_r3, candidate_crossings, candidate_edges, candidate_other_edges = has_r1(sgd)
sgd = apply_r1(sgd, candidate_crossings[0], candidate_edges[0], candidate_other_edges[0])
