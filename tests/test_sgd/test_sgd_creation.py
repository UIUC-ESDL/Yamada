...
def test_unknot_infinity_1e_1c(unknot_inf_cw_1e_1c):
    assert unknot_inf_cw_1e_1c


def test_unknot_infinity_1_2e_1c(unknot_inf_cw_2e_1c):
    assert unknot_inf_cw_2e_1c
