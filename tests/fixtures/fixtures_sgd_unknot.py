...
def unknot_1e_0v():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        e1 = Edge('e1')
        e1[0] = e1[1]
        return SpatialGraphDiagram(edges=[e1],
...
def unknot_2e_0v():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        e1[0] = e2[1]
        e1[1] = e2[0]
        return SpatialGraphDiagram(edges=[e1, e2],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_3e_0v():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        e1[1] = e2[0]
        e2[1] = e3[0]
        return SpatialGraphDiagram(edges=[e1, e2, e3],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_0e_1v():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        v1[0] = v1[1]
        return SpatialGraphDiagram(vertices=[v1],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_2e_1v():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        v1[1] = e1[0]
        e1[1] = e2[0]
        return SpatialGraphDiagram(edges=[e1, e2], vertices=[v1],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_3e_1v():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        e1[1] = e2[0]
        e2[1] = e3[0]
        return SpatialGraphDiagram(edges=[e1, e2, e3], vertices=[v1],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_0e_2v():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        v1[0] = v2[1]
        v1[1] = v2[0]
        return SpatialGraphDiagram(vertices=[v1, v2],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_1e_2v():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        v1[1] = e1[0]
        e1[1] = v2[0]
        return SpatialGraphDiagram(edges=[e1], vertices=[v1, v2],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_2e_2v_1():
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        e1[1] = v2[0]
        v2[1] = e2[0]
        return SpatialGraphDiagram(edges=[e1, e2], vertices=[v1, v2],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_3e_2v_1():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        e2[1] = e3[0]
        e3[1] = v2[0]
        return SpatialGraphDiagram(edges=[e1, e2, e3], vertices=[v1, v2],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_0e_3v():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        v1[1] = v2[0]
        v2[1] = v3[0]
        return SpatialGraphDiagram(vertices=[v1, v2, v3],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_1e_3v():
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        e1[1] = v2[0]
        v2[1] = v3[0]
        return SpatialGraphDiagram(edges=[e1], vertices=[v1, v2, v3],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_2e_3v_1():
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        v2[1] = e2[0]
        e2[1] = v3[0]
        return SpatialGraphDiagram(edges=[e1, e2], vertices=[v1, v2, v3],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
...
def unknot_3e_3v_1():
    ...
    def create_sgd(correct_diagram=True, simplify_diagram=True):
        ...
        v3[0] = e2[1]
        v3[1] = e3[0]
        return SpatialGraphDiagram(edges=[e1, e2, e3], vertices=[v1, v2, v3],
                                   correct_diagram=correct_diagram,
                                   simplify_diagram=simplify_diagram)
    return create_sgd
